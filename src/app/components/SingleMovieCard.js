...
const MyHeroAcademiaSeason7 = ({
  ...
  return (
    <div>
      {/* <div className="bg-gray-900 text-white min-h-screen flex justify-center items-center pt-28 ">
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="md:w-2/3 md:ml-6">
              ...
              <p className="mt-2">
                ...
                can even watch <span className="font-bold">{title}</span> DUB
                in HD quality. You can also find Bones anime on This website.
              </p>
              <div className="mt-4">
      ...
      <div className="bg-gray-900 text-white min-h-screen flex justify-center items-center pt-28 w-full">
        <div className="w-full bg-gray-800 rounded-lg shadow-lg p-6 flex justify-between">
          <div className="flex flex-col md:flex-row p-7">
            ...
            <div className="md:w-full ml-10">
              ...
              {/* <p className="text-gray-400">7th season of</p> */}
              <p className="mt-8">
                HiAnime is the best site to watch{" "}
                <span className="font-bold">{title}</span> SUB online, or you
