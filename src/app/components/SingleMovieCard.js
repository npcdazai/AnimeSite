  ...
  return (
    <div >
      <div
        ...
        className="bg-cover bg-center h-screen  opacity-35 absolute text-white min-h-screen flex justify-center items-center pt-28 w-full "
      />
      <div className="bg-cover bg-center h-screen text-white min-h-screen flex justify-center items-center pt-28 w-full ">
        <div className=" w-full rounded-lg shadow-lg p-6 flex justify-between">
